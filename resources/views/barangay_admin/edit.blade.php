...
<div class="input-form">
  ...
  <div class="form-container">
      ...
      <form action="{{route('barangayadmin.update',$barangay->id)}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="user-details">
              ...
              <div class="input-box">
                <div class="form-group">
                  ...
                  {!! Form::text('name',$barangay->name,['class' => 'form-control'])!!}
                </div>
              </div>
              ...
              <div class="input-box">
                <div class="form-group">
                  ...
                  {!! Form::text('email',$barangay->email,['class' => 'form-control']) !!}
                </div>
              </div>
              ...
              <div class="form-group">
              {!!Form::label('Role:')!!}
                    {!! Form::text('role',$barangay->role,['class' => 'form-control']) !!} 
                </div>
                </div>  -->
