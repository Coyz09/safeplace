...
<div class="input-form">
  ...
  <div class="form-container">
      ...
      <form action="{{route('policestationadmin.update',$policestation->id)}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="user-details">
              ...
              <div class="input-box">
                <div class="form-group">
                  ...
                  {!! Form::text('name',$policestation->name,['class' => 'form-control'])!!}
                </div>
              </div>
              ...
              <div class="input-box">
                <div class="form-group">
                  ...
                  {!! Form::text('email',$policestation->email,['class' => 'form-control']) !!}
                </div>
              </div>
