  ...
  <div class="form-container">
      ...
      <div class="input-box">
              ...
              <div class="form-group">
                    ...
                    {!! Form::select('role',array('' => 'Choose the role:','user_admin' => 'user_admin', 'unverified_user' => 'unverified_user', 'verified_user' => 'verified_user', 'hospital_admin' => 'hospital_admin', 'barangay' => 'barangay', 'barangay_admin' => 'barangay_admin', 'police_station' => 'police_station','policestation_admin' => 'policestation_admin','admin' => 'admin','superadmin' => 'superadmin'), old('role') ,['class' => 'form-control']) !!}
                </div>
                </div> 
