        ...
        <div class="col-md-12">
            <div class="content-box content-single">
                <article class="post-180 gd_place type-gd_place status-publish hentry gd_placecategory-hotels">
                    <header>
                        <h1 class="entry-title">{{ $polices->policestation_name }}</h1></header>
                    <div class="entry-content entry-summary">
                        
                            <div class="geodir-post-slider center-gallery">
                                <div class="bxslider">
                                   
                                    <!-- <div><img src="{{$polices->img }}"></div> -->
                                    <div><img src="{{asset($polices->img)}}" height= "150" width="1000" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="geodir-single-tabs-container">
                            <div class="geodir-tabs" id="gd-tabs">
                                <dl class="geodir-tab-head"><dt></dt>
                                    ...
                                    @if($polices->latitude && $polices->longitude)
                                    ...
                                    <li id="post_contentTab" style="display: none;"><span id="post_content"></span>
                                        ...
                                        <div class="geodir-post-meta-container">
                                            <div class="geodir_post_meta  geodir-field-post_content">
                                                <p>Address: {{ $polices->policestation_location }}</p>
                                                <p>Commander: {{ $polices->policestation_commander}}</p>
                                                <p>Schedule: {{ $polices->policestation_schedule}}</p>
                                                <p>Contact: {{ $polices->policestation_contact}}</p>
                                                ...
                                                <div class="geodir-image-container geodir-image-sizes-medium_large ">
                                                    <div id="geodir_images_5de6cafacbba5_180" class="geodir-image-wrapper" data-controlnav="1" data-slideshow="1">
                                                        <ul class="geodir-gallery geodir-images clearfix">
                                                                ...
                                                                <li>
                                                                    <a href="{{asset($polices->img)}}" class="geodir-lightbox-image" target="_blank"><img src="{{asset($polices->img)}}" width="1440" height="960"><i class="fas fa-search-plus" aria-hidden="true"></i></a>
                                                                </li>
...
@if($polices->latitude && $polices->longitude)
    ...
    <script defer>
        function initialize() {
            var latLng = new google.maps.LatLng({{ $polices->latitude }}, {{ $polices->longitude }});
            var mapOptions = {
                zoom: 14,
                minZoom: 6,
                maxZoom: 17,
                                        ...
                                        <li>
                                            <div class="geodir-post-title">
                                                <h4 class="geodir-entry-title">
                                                    <a href="{{ route('police', $polices->id) }}" title="View: {{ $polices->policestation_name }}">{{ $polices->policestation_name }}</a>
                                                </h4>
                                            </div>
                                            <a href="{{ route('police', $polices->id) }}"><img src="{{asset($polices->img)}}" alt="{{ $polices->policestation_name }}" class="align size-medium_large" width="100" height="100"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="geodir-bubble-meta-side">
                    ...
                    <div class="geodir-output-location geodir-output-location-mapbubble">
                        <div class="geodir_post_meta  geodir-field-post_title"><span class="geodir_post_meta_icon geodir-i-text">
                            ...
                            <span class="geodir_post_meta_title">Place Title: </span></span>{{ $polices->policestation_name }}</div>
                        <div class="geodir_post_meta  geodir-field-address" itemscope="" itemtype="http://schema.org/PostalAddress">
                            ...
                            <span class="geodir_post_meta_title">Address: </span></span><span itemprop="streetAddress">{{ $polices->policestation_location }}</span>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            var marker = new google.maps.Marker({
                ...
                icon:image,
                map: map,
                title: '{{ $polices->policestation_name }}'
            });
