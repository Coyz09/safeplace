        ...
        <div class="col-md-12">
            <div class="content-box content-single">
                <article class="post-180 gd_place type-gd_place status-publish hentry gd_placecategory-hotels">
                    <header>
                        <h1 class="entry-title">{{ $barangays->barangay_name }}</h1></header>
                    <div class="entry-content entry-summary">
                        
                            <div class="geodir-post-slider center-gallery">
                                <div class="bxslider">
                                   
                                    <!-- <div><img src="{{$barangays->img }}"></div> -->
                                    <div><img src="{{asset($barangays->img)}}" height= "150" width="1000" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="geodir-single-tabs-container">
                            <div class="geodir-tabs" id="gd-tabs">
                                <dl class="geodir-tab-head"><dt></dt>
                                    ...
                                    @if($barangays->latitude && $barangays->longitude)
                                    ...
                                    <li id="post_contentTab" style="display: none;"><span id="post_content"></span>
                                        ...
                                        <div class="geodir-post-meta-container">
                                            <div class="geodir_post_meta  geodir-field-post_content">
                                                <p>Address: {{ $barangays->barangay_location }}</p>
                                                <p>Barangay Captain: {{ $barangays->barangay_captain}}</p>
                                                <p>Schedule: {{ $barangays->barangay_schedule}}</p>
                                                <p>Contact: {{ $barangays->barangay_contact}}</p>
                                                ...
                                                <div class="geodir-image-container geodir-image-sizes-medium_large ">
                                                    <div id="geodir_images_5de6cafacbba5_180" class="geodir-image-wrapper" data-controlnav="1" data-slideshow="1">
                                                        <ul class="geodir-gallery geodir-images clearfix">
                                                                ...
                                                                <li>
                                                                    <a href="{{asset($barangays->img)}}" class="geodir-lightbox-image" target="_blank"><img src="{{asset($barangays->img)}}" width="1440" height="960"><i class="fas fa-search-plus" aria-hidden="true"></i></a>
                                                                </li>
...
@if($barangays->latitude && $barangays->longitude)
    ...
    <script defer>
        function initialize() {
            var latLng = new google.maps.LatLng({{ $barangays->latitude }}, {{ $barangays->longitude }});
            var mapOptions = {
                zoom: 14,
                minZoom: 6,
                maxZoom: 17,
                                        ...
                                        <li>
                                            <div class="geodir-post-title">
                                                <h4 class="geodir-entry-title">
                                                    <a href="{{ route('barangay', $barangays->id) }}" title="View: {{ $barangays->barangay_name }}">{{ $barangays->barangay_name }}</a>
                                                </h4>
                                            </div>
                                            <a href="{{ route('barangay', $barangays->id) }}"><img src="{{asset($barangays->img)}}" alt="{{ $barangays->barangay_name }}" class="align size-medium_large" width="100" height="100"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="geodir-bubble-meta-side">
                    ...
                    <div class="geodir-output-location geodir-output-location-mapbubble">
                        <div class="geodir_post_meta  geodir-field-post_title"><span class="geodir_post_meta_icon geodir-i-text">
                            ...
                            <span class="geodir_post_meta_title">Place Title: </span></span>{{ $barangays->barangay_name }}</div>
                        <div class="geodir_post_meta  geodir-field-address" itemscope="" itemtype="http://schema.org/PostalAddress">
                            ...
                            <span class="geodir_post_meta_title">Address: </span></span><span itemprop="streetAddress">{{ $barangays->barangay_location }}</span>
                        </div>
                    </div>
                    </div>
                </div>
