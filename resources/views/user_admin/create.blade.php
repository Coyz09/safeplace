...
<div class="input-form">
  ...
  <div class="form-container">
      ...
      @csrf -->
      {!! Form::open(['route' => 'useradmin.store', 'files' => true]) !!}
          {{ csrf_field() }}
      ...
      <div class="input-box">
              ...
              <div class="form-group">
                    ...
                    {!! Form::select('role',array('' => 'Choose the role:', 'unverified_user' => 'unverified_user', 'verified_user' => 'verified_user'), old('role') ,['class' => 'form-control']) !!}
                </div>
                </div> 
