  ...
  <div class="form-container">
    ...
    <div style ="text-align: center;" class="title">User Details:</div>
                    ...
                    <div class="input-box" style ="text-align: center;">
                      ...
                      @if($police_reports->report_status != "Transferred")
<div class="button">
<form action="{{route('policereport.transfer',$police_reports->id)}}" method="POST" >
  @csrf
  @method('PUT')
  <h4>Transfer to Barangay:</h4>
