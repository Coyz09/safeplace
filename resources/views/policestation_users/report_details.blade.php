        ...
        <div class="user-details">
                ...
                <div class="input-box">
                  <div class="form-group">
                    {!!Form::label('Report Details:')!!}
                    {!! Form::text('report_details',$police_reports->report_details,array('class' => 'form-control')) !!}
                  </div>
                </div>
                ...
                <div class="input-box">
                    <div class="form-group">
                      ...
                      {!! Form::text('report_status',$police_reports->report_status,array('class' => 'form-control')) !!}
                    </div>
                </div>
