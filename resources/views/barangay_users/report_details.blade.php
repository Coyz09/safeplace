        ...
        <div class="user-details">
                ...
                <div class="input-box">
                  <div class="form-group">
                    {!!Form::label('Report Detail')!!}
                    {!! Form::text('barangay_reports',$barangay_reports->report_details,array('class' => 'form-control')) !!}
                  </div>
                </div>
                ...
                <div class="input-box">
                    <div class="form-group">
                      {!!Form::label('Report Status')!!}
                      {!! Form::text('report_status',$barangay_reports->report_status,array('class' => 'form-control')) !!}
                    </div>
                </div>
